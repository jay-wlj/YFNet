...
static std::string GetMD5(QVOD_BYTE* pBuf, QVOD_UINT nLength);
...
void Transform(QVOD_BYTE Block[64]);
void Update(QVOD_BYTE* Input, QVOD_ULONG nInputLen);
std::string Final();
inline QVOD_DWORD RotateLeft(QVOD_DWORD x, int n);
inline void FF( QVOD_DWORD& A, QVOD_DWORD B, QVOD_DWORD C, QVOD_DWORD D, QVOD_DWORD X, QVOD_DWORD S, QVOD_DWORD T);
inline void GG( QVOD_DWORD& A, QVOD_DWORD B, QVOD_DWORD C, QVOD_DWORD D, QVOD_DWORD X, QVOD_DWORD S, QVOD_DWORD T);
inline void HH( QVOD_DWORD& A, QVOD_DWORD B, QVOD_DWORD C, QVOD_DWORD D, QVOD_DWORD X, QVOD_DWORD S, QVOD_DWORD T);
inline void II( QVOD_DWORD& A, QVOD_DWORD B, QVOD_DWORD C, QVOD_DWORD D, QVOD_DWORD X, QVOD_DWORD S, QVOD_DWORD T);

//utility functions
void DWordToByte(QVOD_BYTE* Output, QVOD_DWORD* Input, QVOD_UINT nLength);
void ByteToDWord(QVOD_DWORD* Output, QVOD_BYTE* Input, QVOD_UINT nLength);

private:
QVOD_BYTE m_lpszBuffer[64]; //input buffer
QVOD_ULONG m_nCount[2]; //number of bits, modulo 2^64 (lsb first)
QVOD_ULONG m_lMD5[4]; //MD5 checksum
};
